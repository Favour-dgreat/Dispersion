...
<div id='div1' style={{width: '100%', height: '100%', position: 'relative'}}>
    ...
    <div className={styles.popoutDiv1} style={{left: 150, top: 171, position: 'absolute', background: 'linear-gradient(180deg, #262E30 0%, rgba(6, 12, 12, 0) 100%)', borderRadius: 29.60, justifyContent: 'flex-start', alignItems: 'flex-start', gap: 14.80, display: 'inline-flex'}}>
    ...
    <div className={styles.popoutDiv2} style={{left: 725, top: 170, position: 'absolute', background: 'linear-gradient(180deg, #262E30 0%, rgba(6, 12, 12, 0) 100%)', borderRadius: 28.80, justifyContent: 'flex-start', alignItems: 'flex-start', gap: 14.40, display: 'inline-flex'}}>
