...
<div style={{width: '100%', height: '100%', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-end', gap: 90, display: 'inline-flex'}}>
<div id='div1' className={styles.animatedDiv} style={{justifyContent: 'flex-start', alignItems: 'center', display: 'inline-flex', marginTop:'2%'}}>
...
<div id='div2' className={styles.animatedDiv} style={{width: '100%', height: '100%', justifyContent: 'flex-start', alignItems: 'center', display: 'inline-flex'}}>
...
<div id='div3'className={styles.animatedDiv} style={{justifyContent: 'flex-start', alignItems: 'center', display: 'inline-flex', marginTop:'2%'}}>
<div style={{justifyContent: 'flex-start', alignItems: 'center', display: 'flex'}}>
<div style={{justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10, display: 'flex'}}>
<div style={{width: 64, paddingLeft:'120', height: 64, background: 'linear-gradient(89deg, #00D4F7 0%, #029EEC 26%, #5172E5 47%, #5671E4 65%, #8957DF 74%, #BB40D9 86%, #E235D5 100%)', borderRadius: 9999}} />
{/* <div style={{width: 53, height: 53, background: '#D9D9D9', borderRadius: 9999}} /> */}
